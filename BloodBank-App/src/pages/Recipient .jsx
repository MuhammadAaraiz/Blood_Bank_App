...
export const Recipient = () => {
    ...
    const Response_Record = () => {
        Swal.fire({
            title: "Thankyou Your Response has been Recorder ",
    ...
    const Database_submit_handle = () => {
        const new_message_key = push(child(ref(database), "Recipient")).key;
        set(ref(database, `Recipient/${new_message_key}`), {
