...
export const Donors_List = () => {
    ...
    useEffect(() => {
        const database_ref = ref(database, "Donor/");
    ...
    return (
        <>
            <div style={{ textAlign: 'center', backgroundColor: 'aliceblue' }}>
                <h1 style={{ textAlign: 'center', fontSize: '30px' }}>Donor,s List</h1>
                        ...
                        return (<>
                            <div key={i} className="card ">
                                <div className="card-content">
                                    ...
                                    <h3 className="card-title text-center"> Contact Number : {Number} </h3><br />
